...
- Found in src/protocol/ThunderLoan.sol [Line: 332](src/protocol/ThunderLoan.sol#L332)

	```solidity
	    function getAssetFromToken(IERC20 token) public view returns (AssetToken) {
	```

- Found in src/protocol/ThunderLoan.sol [Line: 336](src/protocol/ThunderLoan.sol#L336)
